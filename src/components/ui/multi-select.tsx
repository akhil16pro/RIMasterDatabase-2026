...
const multiSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
  variants: {
    variant: {
      default:
        "border-foreground/10 text-[var(--textColor)] bg-muted hover:bg-muted-foreground/30",
      secondary:
        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-none border-b min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto ",
            ...
            >
              {selectedValues.length > 0 ? (
                <div className="flex justify-between items-center w-full">
                  ...
                  >
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      <Badge
                        className={cn(
                          "bg-transparent text-[var(--textColor)] border-foreground/1 hover:bg-transparent",
                          getBadgeAnimationClass(),
                          multiSelectVariants({ variant }),
                          responsiveSettings.compactMode &&
                ...
                <div className="flex items-center justify-between w-full mx-auto">
                  ...
                  <ChevronDown className="h-4 cursor-pointer text-muted-foreground ms-2" />
                </div>
              )}
            </Button>
          </PopoverTrigger>
            ...
            <Command>
              ...
              <CommandList
                className={cn(
                  ...
                  "[&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-primary [&::-webkit-scrollbar-track]:bg-gray-200",
                )}
              >
                <CommandEmpty>
                ...
                {!hideSelectAll && !searchValue && (
                  <CommandGroup>
                    ...
                    >
                      <div
                        className={cn(
                          "mr-2 flex h-4 w-4 items-center justify-center rounded-[4px] border border-muted-foreground",
                          selectedValues.length ===
          ...
          {animation > 0 && selectedValues.length > 0 && (
            <WandSparkles
              className={cn(
                "cursor-pointer my-2 text-[var(--textColor)] bg-background w-3 h-3",
