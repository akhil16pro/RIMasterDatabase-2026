...
export const Route = createFileRoute("/$lang/_lang/_auth/campaign")({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <DialogContent className="lg:max-w-4xl">
          <DialogHeader>
            <DialogTitle>{t("add_campaign")}</DialogTitle>
          </DialogHeader>
          <div className="grid md:grid-cols-2 gap-x-8 gap-y-7 items-start">
            <form.Field
              name="title"
              ...
              children={(field) => (
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    field.form.setFieldValue("campaign_end_date", "");
                  }}
            ...
            <form.Field
              ...
              validators={{
                onChange: ({ value, fieldApi }) => {
                  ...
                  const treatyDate = new Date(
                    fieldApi.form.getFieldValue("campaign_start_date"),
                  );
              ...
              children={(field) => (
                <form.Subscribe
                  selector={(state) => state.values.campaign_start_date}
                >
                  {(campaignStartDateValue) => (
                    <Input
                      type="date"
