                  ...
                  <div className="flex flex-col lg:flex-row rounded-lg overflow-hidden  min-h-[75vh] px-5 md:px-0">
                    <div className="flex-2/4 bg-[linear-gradient(190deg,#020355_-50.47%,#304FD0_100%)] p-10 px-[10%] flex flex-col items-center justify-center gap-5">
                      ...
                      <img
                        ...
                        className="h-auto object-contain md:w-[7rem] w-[5rem]"
                      />
                      <div className="font-medium text-[2.2rem] md:text-[2.7rem] lg:text-[2.45rem]    text-text/80 relative block bg-gradient-to-r from-white to-secondary bg-clip-text text-transparent  leading-[100%] text-center">
                        {data.title}
                      </div>
                    </div>
                    <div className="flex-2/3 bg-white p-5 md:p-10 flex flex-col  justify-center gap-5">
                      ...
                      <form action="" className='flex flex-col gap-7'>
                        ...
                        <div className="relative flex items-center gap-2">
                          <label className="text-[1.2rem] text-black font-secondary">{t("forgot_password")}</label>
                          <Link to={"/" + i18n.language + "/forgot-password"} className="text-[1.2rem] text-black font-secondary underline text-secondary hover:text-primary transition-colors duration-300">
                            <span>{t("reset")}</span>
                          </Link>
                        </div>
                        <DefaultButton
